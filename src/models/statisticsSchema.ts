...
export const enum StatisticType {
    ...
    Command_Settings_GuildLink = "Command_Settings_QuoteLink",
    Command_Settings_GuildUnlink = "Command_Settings_QuoteUnlink",
    Command_Settings_GuildLinkList = "Command_Settings_QuoteLinkList",
